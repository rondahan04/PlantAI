...
export const he: Copy = {
  ...
  careHistory: {
    ...
    photo: {
      short: 'תמונות',
      title: 'יומן גדילה',
      empty: 'עוד אין תמונות - הוסיפו אחת מהצמח כדי להתחיל את היומן.',
      logged: (n: number) => (n === 1 ? 'תמונה אחת' : `${n} תמונות`),
      noneThisMonth: 'אין תמונות בחודש הזה',
      one: 'תמונה',
      openJournal: 'פתיחת יומן הגדילה',
    },
    allTitle: 'היסטוריית טיפול',
    allEmpty: 'עוד לא תועד דבר - השקו, החליפו עציץ, דשנו, עקבו אחרי עלה חדש או הוסיפו תמונה כדי להתחיל.',
    allLogged: (n: number) => (n === 1 ? 'רישום אחד בלוח' : `${n} רישומים בלוח`),
    allNoneThisMonth: 'לא תועד דבר החודש',
    daysOfCare: (n: number) => (n === 1 ? 'יום אחד מסומן החודש' : `${n} ימים מסומנים החודש`),
    filterAll: 'הכל',
    ...
    /* Not "בוצע" - a photograph is added, not performed. */
    photoDoneSuffix: ', נוספה תמונה',
  ...
  plantDetail: {
    ...
    checkIt: 'לבדוק',
    checking: 'בודקים…',
    checkA11y: (name: string) => `בדיקת ${name}`,
    checkFailedTitle: 'הבדיקה לא הושלמה',
    issues: 'בעיות שזוהו',
    treatments: 'תוכנית טיפול',
    urgent: 'דחוף',
    findProduct: (product: string) => `למצוא ${product} בסביבה`,
  ...
  portfolio: {
    ...
    filterWatchingA11y: 'הצגת הצמחים עם אבחון קל או בינוני שכדאי לעקוב אחריהם',
    filterDiagnosedA11y: 'הצגת הצמחים שאובחנו בלבד',
    dueThisWeek: 'לטיפול השבוע',
    dueMore: (n: number) => `ועוד ${n} - להצגת הכול`,
    dueLess: 'להצגה מצומצמת',
    dueMoreA11y: (n: number) => `הצגת ${n} צמחים נוספים להשקיה השבוע`,
    dueLessA11y: 'הצגה מצומצמת של הצמחים להשקיה השבוע',
    noneNeedCare: 'אין משימות כרגע. כל הצמחים בזמן.',
    noneWatching: 'אין כרגע צמחים במעקב. אף צמח לא אובחן כקל או בינוני.',
  ...
  growthCard: {
    title: 'יומן גדילה',
    note: 'צלמו מדי פעם, ותראו איך הצמח משתנה.',
    empty: 'עוד אין תמונות. הראשונה היא תחילת הסיפור.',
    /* Hebrew drops the numeral in the singular - "תמונה אחת", never "1
     * תמונות" - which is the whole reason these are functions. */
    count: (n: number) => (n === 1 ? 'תמונה אחת' : `${n} תמונות`),
    span: (n: number) => (n === 1 ? 'לאורך יום אחד' : `לאורך ${n} ימים`),
    add: 'הוספת תמונה',
    addA11y: (name: string) => `הוספת תמונת גדילה ל${name}`,
    open: 'לכל התמונות',
    openA11y: 'פתיחת יומן הגדילה',
    thumbA11y: (when: string) => `תמונת גדילה, ${when}`,
  },
  growthJournal: {
    title: 'יומן גדילה',
    back: 'לצמח',
    backA11y: 'חזרה לצמח',
    calendarA11y: 'לראות את התמונות בלוח השנה של הטיפול',
    emptyTitle: 'עוד אין כאן כלום',
    emptyBody: 'הוסיפו תמונה בכל פעם שמשהו מושך את העין. בעוד חודש הן נקראות כתמונה אחת.',
    add: 'הוספת תמונה',
    addA11y: 'הוספת תמונת גדילה',
    sourceTitle: 'הוספת תמונת גדילה',
    sourceCamera: 'צילום תמונה',
    sourceLibrary: 'בחירה מהגלריה',
    cancel: 'ביטול',
    cameraDenied: 'הגישה למצלמה חסומה ל-PlantAI. אפשר להפעיל אותה בהגדרות.',
    libraryDenied: 'הגישה לתמונות חסומה ל-PlantAI. אפשר להפעיל אותה בהגדרות.',
    photoMissing: 'התמונה הזו לא נמצאה בטלפון.',
    today: 'היום',
    yesterday: 'אתמול',
    daysAgo: (n: number) => `לפני ${n} ימים`,
    count: (n: number) => (n === 1 ? 'תמונה אחת' : `${n} תמונות`),
    ...
    notePlaceholder: 'מה השתנה?',
    noteSave: 'שמירה',
    noteCancel: 'ביטול',
    noteA11y: 'כתיבת הערה על התמונה',
    remove: 'מחיקה',
    removeA11y: 'מחיקת התמונה הזו',
    removeTitle: 'למחוק את התמונה?',
    removeBody: 'התמונה וההערה שלה יימחקו, ואי אפשר לשחזר.',
    removeConfirm: 'מחיקה',
    failTitle: 'זה לא נשמר',
    failStorage: 'אין מספיק מקום בטלפון. פנו קצת מקום ונסו שוב.',
  },
  scheduleCard: {
    water: {
      title: 'השקיה',
